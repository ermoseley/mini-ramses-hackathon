...
J2=$(DMO_SLURM_TIME=04:00:00 hackathon_sbatch --dependency=afterany:"${J1}" --time=04:00:00 \
  --export=ALL,GPU_INIT=BGAUSS,BIN_GPU="${MINIRAM}/bin/ramses3d.mhd.ambigauss",BUILD_BINARIES=1 \
...
J3=$(DMO_SLURM_TIME=04:00:00 hackathon_sbatch --dependency=afterany:"${J2}" --time=04:00:00 \
  --export=ALL,GPU_INIT=ALFVENAD,BIN_GPU="${MINIRAM}/bin/ramses3d.mhd.alfvenad",BUILD_BINARIES=1 \
